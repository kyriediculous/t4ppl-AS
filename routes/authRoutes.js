...
const sg             = require('sendgrid')('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');
const helper         = require('sendgrid').mail;
const User           = require('../models/User');
const router         = express.Router();
const stripe        = require("stripe")("pk_test_NPnxAy3RQSO93ZvBE3GJZpO1");
